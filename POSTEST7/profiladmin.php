...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-nav">
            ...
            <a href="produk.php" onclick="alert('akses produk')">Produk</a>
        </div>
    ...
    <div class="user-profile">
        ...
        <div class="profile-item actions">
            <a href="ubahpasswordadmin.php?id=<?= $user_data['id']; ?>">Ubah Password</a>
            <a href="editadmin.php?id=<?= $user_data['id']; ?>">Edit</a>
        </div>
    </div>
</body>
