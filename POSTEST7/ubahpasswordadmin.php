        ...
        if ($newPassword == $confirmPassword) {
            ...
            if ($updatePassword) {
                echo "
                    ...
                    document.location.href = 'profiladmin.php'; // Redirect to admin profile or wherever you want
                    </script>
                ";
            } else {
                echo "
                    ...
                    document.location.href = 'ubahpasswordadmin.php'; // Redirect back to the change password page
                    </script>
                ";
            }
        } else {
...
<body>
  <div class="container">
    <h1>Ubah Password</h1>
    <form method="POST" action="ubahpasswordadmin.php">
