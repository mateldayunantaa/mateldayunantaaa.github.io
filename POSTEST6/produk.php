    ...
    <table border="1">
        ...
        foreach ($produk as $pdk) : ?>
            <tr>
                ...
                <td> <img src = "img/<?= $pdk ['gambar'] ?>" alt ="ini gambar" width="80px" height="70px"></td>
                <td><a href='editproduk.php?id=<?= $pdk["id_produk"] ?>'>Edit</a></td>
                <td><a href='hapusproduk.php?id=<?= $pdk["id_produk"] ?>'>hapus</a>
                </td>
            </tr>
        <?php $i++;
        endforeach; ?>
